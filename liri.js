...
function gettweets() {
	...
	var params = {screen_name: 'FireFlare002', count: 20};
...
function getsong(song) {
	...
	//no song defaults to 'The Sign' by Ace Of Base
	var search;
	if (song === '') {
...
// retrieve information on a movie from OMDB
...
// if else and switch to determine what its doing
